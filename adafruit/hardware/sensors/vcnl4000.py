...
class VCNL4000(object):
    ...
    __781K25    = 2
    __390K625   = 3
    __FREQUENCIES = ((self.__3M125, '3.125 MHz'),
                     (self.__1M5625, '1.5625 MHz'),
                     (self.__781K25, '781.25 KHz'),
                     (self.__390K625, '390.625 KHz'))
    ...
    def __init__(self, address=0x40, debug=False):
        ...
        if self.debug:
            ...
            print "proximity measurement frequency = %s" % self.__FREQUENCIES[freq]
